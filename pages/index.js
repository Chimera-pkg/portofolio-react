        ...
        <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900" >
          <section className="min-h-screen">
            <nav className='py-10 mb-12 flex justify-between'>
              <h1 className="text-xl font-burtons dark:text-white">prawira_dev</h1>
            ...
            <div className="cursor-pointer text-5xl flex justify-center gap-16 py-3 text-gray-600">
              <a href="https://www.instagram.com/prawirraa/" target="_blank" rel="noopener noreferrer">
                <AiFillInstagram />
              </a>
              <a href="https://www.linkedin.com/in/muhammad-adryan-prawira-kusuma-b7a295200/" target="_blank" rel="noopener noreferrer">
                <AiFillLinkedin />
              </a>
              <a href="https://www.youtube.com/channel/UCP4STUxfw5sO6z-REiYp_yQ" target="_blank" rel="noopener noreferrer">
                <AiFillYoutube />
              </a>
            </div>
